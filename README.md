...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/python-cudnn-frontend-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-cudnn-frontend-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-cudnn-frontend
# for installing globally
pixi global install python-cudnn-frontend
```
...
It is possible to list all of the versions of `python-cudnn-frontend` available on your platform:
...
```
pixi search python-cudnn-frontend --channel conda-forge
```
